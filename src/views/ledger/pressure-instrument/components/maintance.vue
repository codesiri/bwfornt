    ...
    <template #default>
      ...
      >
        <el-form-item label="位号" prop="pressureTag">
          <el-input v-model="formData.pressureTag" :disabled="true" placeholder="位号" />
        </el-form-item>
...
import { DvPressureInstrumentMaintenanceForm } from "@/views/ledger/pressure-instrument";
const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<DvPressureInstrumentMaintenanceForm>("formdata", { required: true });
