...
import TnkMeterAPI from "@/api/ledger/tnk-meter-api";
...
const handleDownloadTemplate = () => {
  TnkMeterAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await TnkMeterAPI.importFile(importFormData.files[0].raw as File);
