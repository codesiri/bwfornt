    ...
    <template #default>
      ...
      >
        <el-form-item label="仪表位号" prop="tnkMeterTag">
          <el-input v-model="formData.tnkMeterTag" :disabled="true" placeholder="仪表位号" />
        </el-form-item>
...
import { TnkMeterMaintenanceForm } from "@/views/ledger/tnk-meter";
const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<TnkMeterMaintenanceForm>("formdata", { required: true });
