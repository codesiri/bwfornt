    ...
    <template #default>
      ...
      >
        <el-form-item label="元器件名称" prop="ecmComponentName">
          <el-input v-model="formData.ecmComponentName" :disabled="true" placeholder="元器件名称" />
        </el-form-item>
...
import { ElectricCabinetMainComponentMaintenanceForm } from "@/views/ledger/electric-cabinet-main-component";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<ElectricCabinetMainComponentMaintenanceForm>("formdata", {
  required: true,
});
