...
import SeCompressorAPI from "@/api/ledger/se-compressor-api";
...
const handleDownloadTemplate = () => {
  SeCompressorAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await SeCompressorAPI.import(importFormData.files[0].raw as File);
