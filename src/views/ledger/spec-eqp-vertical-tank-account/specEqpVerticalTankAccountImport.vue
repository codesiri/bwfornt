...
import SpecEqpVerticalTankAccountAPI from "@/api/ledger/spec-eqp-vertical-tank-account-api";
...
const handleDownloadTemplate = () => {
  SpecEqpVerticalTankAccountAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await SpecEqpVerticalTankAccountAPI.import(importFormData.files[0].raw as File);
