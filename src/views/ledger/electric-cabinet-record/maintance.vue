    ...
    <template #default>
      ...
      >
        <el-form-item label="巡检项目" prop="ecrInspectItem">
          <el-input v-model="formData.ecrInspectItem" :disabled="true" placeholder="巡检项目" />
        </el-form-item>
...
import { ElectricCabinetRecordMaintenanceForm } from "@/views/ledger/electric-cabinet-record";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<ElectricCabinetRecordMaintenanceForm>("formdata", { required: true });
