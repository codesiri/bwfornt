    ...
    <template #default>
      ...
      >
        <el-form-item label="变更内容" prop="eccChangeContent">
          <el-input v-model="formData.eccChangeContent" :disabled="true" placeholder="变更内容" />
        </el-form-item>
...
import { ElectricCabinetChangeMaintenanceForm } from "@/views/ledger/electric-cabinet-change";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<ElectricCabinetChangeMaintenanceForm>("formdata", { required: true });
