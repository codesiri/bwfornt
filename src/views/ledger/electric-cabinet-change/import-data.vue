...
import ElectricCabinetChangeAPI from "@/api/ledger/electric-cabinet-change-api";
...
const handleDownloadTemplate = () => {
  ElectricCabinetChangeAPI.downloadtemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await ElectricCabinetChangeAPI.import(importFormData.files[0].raw as File);
