...
import ElectricCabinetFaultAPI from "@/api/ledger/electric-cabinet-fault-api";
...
const handleDownloadTemplate = () => {
  ElectricCabinetFaultAPI.downloadtemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await ElectricCabinetFaultAPI.import(importFormData.files[0].raw as File);
