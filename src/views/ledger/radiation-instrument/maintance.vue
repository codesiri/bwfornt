...
import { RadiationInstrumentMaintenanceForm } from "@/views/ledger/radiation-instrument";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<RadiationInstrumentMaintenanceForm>("formdata", { required: true });
