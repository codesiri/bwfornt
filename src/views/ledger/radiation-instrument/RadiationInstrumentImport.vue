...
import RadiationInstrumentAPI from "@/api/ledger/radiation-instrument-api";
...
const handleDownloadTemplate = () => {
  RadiationInstrumentAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await RadiationInstrumentAPI.import(importFormData.files[0].raw as File);
