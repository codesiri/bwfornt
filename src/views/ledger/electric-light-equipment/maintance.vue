    ...
    <template #default>
      ...
      >
        <el-form-item label="照明设备编号" prop="eleLightCode">
          <el-input v-model="formData.eleLightCode" :disabled="true" placeholder="照明设备编号" />
        </el-form-item>
...
import { ElectricLightEquipmentMaintenanceForm } from "@/views/ledger/electric-light-equipment";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<ElectricLightEquipmentMaintenanceForm>("formdata", { required: true });
