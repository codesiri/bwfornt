...
import DvTemperatureGaugeAPI from "@/api/ledger/dv-temperature-gauge-api";
...
const handleUpload = async () => {
  ...
  try {
    const result = await DvTemperatureGaugeAPI.importFile(importFormData.files[0].raw as File);
