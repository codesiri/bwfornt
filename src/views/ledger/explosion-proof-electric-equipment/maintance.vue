    ...
    <template #default>
      ...
      >
        <el-form-item label="设备编号" prop="equipmentCode">
          <el-input v-model="formData.equipmentCode" :disabled="true" placeholder="设备编号" />
        </el-form-item>
...
import { ExplosionProofElectricEquipmentMaintenanceForm } from "@/views/ledger/explosion-proof-electric-equipment";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<ExplosionProofElectricEquipmentMaintenanceForm>("formdata", { required: true });
