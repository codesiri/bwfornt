...
import ExplosionProofElectricEquipmentAPI from "@/api/ledger/explosion-proof-electric-equipment-api";
...
const handleDownloadTemplate = () => {
  ExplosionProofElectricEquipmentAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await ExplosionProofElectricEquipmentAPI.import(
