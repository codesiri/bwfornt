...
import DvFlowmetreInfoAPI from "@/api/ledger/dv-flowmetre-info-api";
...
const handleDownloadTemplate = () => {
  DvFlowmetreInfoAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await DvFlowmetreInfoAPI.importFile(importFormData.files[0].raw as File);
