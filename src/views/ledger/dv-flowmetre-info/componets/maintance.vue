    ...
    <template #default>
      ...
      >
        <el-form-item label="仪表位号" prop="tagNumber">
          <el-input v-model="formData.tagNumber" :disabled="true" placeholder="仪表位号" />
        </el-form-item>
...
import { DvFlowmetreInfoMaintenanceForm } from "@/views/ledger/dv-flowmetre-info";
const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<DvFlowmetreInfoMaintenanceForm>("formdata", { required: true });
