...
import SeHeaterAPI from "@/api/ledger/se-heater-api";
...
const handleDownloadTemplate = () => {
  SeHeaterAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await SeHeaterAPI.import(importFormData.files[0].raw as File);
