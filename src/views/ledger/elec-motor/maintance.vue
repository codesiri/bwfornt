    ...
    <template #default>
      ...
      >
        <el-form-item label="位号" prop="elecMotorTag">
          <el-input v-model="formData.elecMotorTag" :disabled="true" placeholder="位号" />
        </el-form-item>
...
import { ElecMotorMaintenanceForm } from "@/views/ledger/elec-motor";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<ElecMotorMaintenanceForm>("formdata", { required: true });
