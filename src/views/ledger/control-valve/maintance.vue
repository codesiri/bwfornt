    ...
    <template #default>
      ...
      >
        <el-form-item label="位号" prop="tagNo">
          <el-input v-model="formData.tagNo" :disabled="true" placeholder="位号" />
        </el-form-item>
...
import { ControlValveMaintenanceForm } from "@/views/ledger/control-valve";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<ControlValveMaintenanceForm>("formdata", { required: true });
