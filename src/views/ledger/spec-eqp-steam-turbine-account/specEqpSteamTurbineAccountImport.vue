...
import SpecEqpSteamTurbineAccountAPI from "@/api/ledger/spec-eqp-steam-turbine-account-api";
...
const handleDownloadTemplate = () => {
  SpecEqpSteamTurbineAccountAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await SpecEqpSteamTurbineAccountAPI.import(importFormData.files[0].raw as File);
