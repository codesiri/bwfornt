...
import SeRefrigeratorAPI from "@/api/ledger/se-refrigerator-api";
...
const handleDownloadTemplate = () => {
  SeRefrigeratorAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await SeRefrigeratorAPI.import(importFormData.files[0].raw as File);
