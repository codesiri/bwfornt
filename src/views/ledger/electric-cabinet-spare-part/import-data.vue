...
import ElectricCabinetRecordAPI from "@/api/ledger/electric-cabinet-record-api";
...
const handleDownloadTemplate = () => {
  ElectricCabinetRecordAPI.downloadtemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await ElectricCabinetRecordAPI.import(importFormData.files[0].raw as File);
