    ...
    <template #default>
      ...
      >
        <el-form-item label="资料名称" prop="ecdDocName">
          <el-input v-model="formData.ecdDocName" :disabled="true" placeholder="资料名称" />
        </el-form-item>
...
import { ElectricCabinetDocumentMaintenanceForm } from "@/views/ledger/electric-cabinet-document";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<ElectricCabinetDocumentMaintenanceForm>("formdata", { required: true });
