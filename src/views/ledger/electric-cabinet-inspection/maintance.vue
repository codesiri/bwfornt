...
import { ElectricCabinetInspectionMaintenanceForm } from "@/views/ledger/electric-cabinet-inspection";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<ElectricCabinetInspectionMaintenanceForm>("formdata", {
  required: true,
});
