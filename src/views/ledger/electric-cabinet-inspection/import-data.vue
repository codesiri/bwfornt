...
import ElectricLightEquipmentAPI from "@/api/ledger/electric-light-equipment-api";
import ElectricCabinetDocumentAPI from "@/api/ledger/electric-cabinet-document-api";
...
const handleDownloadTemplate = () => {
  ElectricCabinetDocumentAPI.downloadtemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await ElectricLightEquipmentAPI.import(importFormData.files[0].raw as File);
