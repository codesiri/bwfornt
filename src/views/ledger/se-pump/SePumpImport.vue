...
import SePumpAPI from "@/api/ledger/se-pump-api";
...
const handleDownloadTemplate = () => {
  SePumpAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await SePumpAPI.import(importFormData.files[0].raw as File);
