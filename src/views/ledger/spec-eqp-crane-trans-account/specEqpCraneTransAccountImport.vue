...
import SpecEqpCraneTransAccountAPI from "@/api/ledger/spec-eqp-crane-trans-account-api";
...
const handleDownloadTemplate = () => {
  SpecEqpCraneTransAccountAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await SpecEqpCraneTransAccountAPI.import(importFormData.files[0].raw as File);
