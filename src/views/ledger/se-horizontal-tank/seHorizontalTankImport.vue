...
import SeHorizontalTankAPI from "@/api/ledger/se-horizontal-tank-api";
...
const handleDownloadTemplate = () => {
  SeHorizontalTankAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await SeHorizontalTankAPI.import(importFormData.files[0].raw as File);
