...
import GroundSystemEquipmentAPI from "@/api/ledger/ground-system-equipment-api";
...
const handleDownloadTemplate = () => {
  GroundSystemEquipmentAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await GroundSystemEquipmentAPI.import(importFormData.files[0].raw as File);
