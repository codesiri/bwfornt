    ...
    <template #default>
      ...
      >
        <el-form-item label="接地编号" prop="gseGroundCode">
          <el-input v-model="formData.gseGroundCode" :disabled="true" placeholder="接地编号" />
        </el-form-item>
...
import { GroundSystemEquipmentMaintenanceForm } from "@/views/ledger/ground-system-equipment";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<GroundSystemEquipmentMaintenanceForm>("formdata", { required: true });
