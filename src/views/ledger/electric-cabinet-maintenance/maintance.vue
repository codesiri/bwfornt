...
import { ElectricCabinetMaintenanceMaintenanceForm } from "@/views/ledger/electric-cabinet-maintenance";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<ElectricCabinetMaintenanceMaintenanceForm>("formdata", {
  required: true,
});
