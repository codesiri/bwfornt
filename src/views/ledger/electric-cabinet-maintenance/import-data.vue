...
import ElectricCabinetMaintenanceAPI from "@/api/ledger/electric-cabinet-maintenance-api";
...
const handleDownloadTemplate = () => {
  ElectricCabinetMaintenanceAPI.downloadtemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await ElectricCabinetMaintenanceAPI.importFile(importFormData.files[0].raw as File);
