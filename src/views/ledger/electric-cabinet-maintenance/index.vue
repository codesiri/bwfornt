  ...
  <div class="app-container">
    ...
    >
      <el-form ref="dataFormRef" :model="formData" :rules="rules" label-width="100px">
                ...
                <el-form-item label="保养人员" prop="ecmMaintainPerson">
                      <el-input
                          v-model="formData.ecmMaintainPerson"
                          placeholder="保养人员"
                      />
                </el-form-item>
                ...
                <el-form-item label="保养级别" prop="ecmMaintainLevel">
                      <el-input
                          v-model="formData.ecmMaintainLevel"
                          placeholder="保养级别"
                      />
                </el-form-item>
                ...
                <el-form-item label="保养项目" prop="ecmMaintainItem">
                      <el-input
                          v-model="formData.ecmMaintainItem"
                          placeholder="保养项目"
                      />
                </el-form-item>
                ...
                <el-form-item label="保养内容" prop="ecmMaintainContent">
                      <el-input
                          v-model="formData.ecmMaintainContent"
                          placeholder="保养内容"
                      />
                </el-form-item>
                ...
                <el-form-item label="更换元器件" prop="ecmReplaceComponent">
                      <el-input
                          v-model="formData.ecmReplaceComponent"
                          placeholder="更换元器件"
                      />
                </el-form-item>
                ...
                <el-form-item label="保养结果" prop="ecmMaintainResult">
                      <el-input
                          v-model="formData.ecmMaintainResult"
                          placeholder="保养结果"
                      />
                </el-form-item>
...
<script setup lang="ts">
  ...
  import ElectricCabinetMaintenanceAPI, { ElectricCabinetMaintenancePageVO, ElectricCabinetMaintenanceForm, ElectricCabinetMaintenancePageQuery } from "@/api/ledger/electric-cabinet-maintenance-api";
  ...
  function handleSubmit() {
    dataFormRef.value.validate((valid: any) => {
      if (valid) {
        ...
        if (id) {
                ElectricCabinetMaintenanceAPI.update(id, formData)
              .then(() => {
