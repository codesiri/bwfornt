    ...
    <template #default>
      ...
      >
        <el-form-item label="继电器编号" prop="rpsRelayCode">
          <el-input v-model="formData.rpsRelayCode" :disabled="true" placeholder="继电器编号" />
        </el-form-item>
...
import { RelayProtectionSettingMaintenanceForm } from "@/views/ledger/relay-protection-setting";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<RelayProtectionSettingMaintenanceForm>("formdata", { required: true });
