...
import RelayProtectionSettingAPI from "@/api/ledger/relay-protection-setting-api";
...
const handleDownloadTemplate = () => {
  RelayProtectionSettingAPI.downloadtemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await RelayProtectionSettingAPI.import(importFormData.files[0].raw as File);
