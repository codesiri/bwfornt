    ...
    >
      <el-form ref="dataFormRef" :model="formData" :rules="rules" label-width="100px">
                ...
                <el-form-item label="额定电流（A）" prop="ecduRatedCurrent">
                      <el-input
                          v-model="formData.ecduRatedCurrent"
                          placeholder="额定电流（A）"
                      />
                </el-form-item>
                ...
                <el-form-item label="额定电压（V）" prop="ecduRatedVoltage">
                      <el-input
                          v-model="formData.ecduRatedVoltage"
                          placeholder="额定电压（V）"
                      />
                </el-form-item>
                ...
                <el-form-item label="开关型号" prop="ecduSwitchModel">
                      <el-input
                          v-model="formData.ecduSwitchModel"
                          placeholder="开关型号"
                      />
                </el-form-item>
                ...
                <el-form-item label="开关厂家" prop="ecduSwitchManufacturer">
                      <el-input
                          v-model="formData.ecduSwitchManufacturer"
                          placeholder="开关厂家"
                      />
                </el-form-item>
                ...
                <el-form-item label="整定电流（A）" prop="ecduSettingCurrent">
                      <el-input
                          v-model="formData.ecduSettingCurrent"
                          placeholder="整定电流（A）"
                      />
                </el-form-item>
                ...
                <el-form-item label="对应负载" prop="ecduCorrespondingLoad">
                      <el-input
                          v-model="formData.ecduCorrespondingLoad"
                          placeholder="对应负载"
                      />
                </el-form-item>
                ...
                <el-form-item label="安装位置" prop="ecduInstallLocation">
                      <el-input
                          v-model="formData.ecduInstallLocation"
                          placeholder="安装位置"
                      />
                </el-form-item>
                ...
                <el-form-item label="单元状态" prop="ecduUnitStatus">
                      <el-input
                          v-model="formData.ecduUnitStatus"
                          placeholder="单元状态"
                      />
                </el-form-item>
                ...
                <el-form-item label="所属工厂" prop="ecduFactory">
                      <el-input
                          v-model="formData.ecduFactory"
                          placeholder="所属工厂"
                      />
                </el-form-item>

                <el-form-item label="备用1" prop="ecduReserve1">
                      <el-input
                          v-model="formData.ecduReserve1"
                          placeholder="备用1"
                      />
                </el-form-item>

                <el-form-item label="备用2" prop="ecduReserve2">
                      <el-input
                          v-model="formData.ecduReserve2"
                          placeholder="备用2"
                      />
                </el-form-item>

                <el-form-item label="备用3" prop="ecduReserve3">
                      <el-input
                          v-model="formData.ecduReserve3"
                          placeholder="备用3"
                      />
                </el-form-item>
...
<script setup lang="ts">
  ...
  import ElectricCabinetDrawerUnitAPI, { ElectricCabinetDrawerUnitPageVO, ElectricCabinetDrawerUnitForm, ElectricCabinetDrawerUnitPageQuery } from "@/api/ledger/electric-cabinet-drawer-unit-api";
  ...
  function handleSubmit() {
    dataFormRef.value.validate((valid: any) => {
      if (valid) {
        ...
        if (id) {
                ElectricCabinetDrawerUnitAPI.update(id, formData)
              .then(() => {
