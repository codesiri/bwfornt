...
import SeFanAPI from "@/api/ledger/se-fan-api";
...
const handleDownloadTemplate = () => {
  SeFanAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await SeFanAPI.import(importFormData.files[0].raw as File);
