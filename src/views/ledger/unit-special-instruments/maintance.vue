...
import { UnitSpecialInstrumentsMaintenanceForm } from "@/views/ledger/unit-special-instruments";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<UnitSpecialInstrumentsMaintenanceForm>("formdata", { required: true });
