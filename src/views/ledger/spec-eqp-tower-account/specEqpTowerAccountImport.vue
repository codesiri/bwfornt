...
import SpecEqpTowerAccountAPI from "@/api/ledger/spec-eqp-tower-account-api";
...
const handleDownloadTemplate = () => {
  SpecEqpTowerAccountAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await SpecEqpTowerAccountAPI.import(importFormData.files[0].raw as File);
