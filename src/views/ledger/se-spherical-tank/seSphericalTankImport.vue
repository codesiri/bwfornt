...
import SeSphericalTankAPI from "@/api/ledger/se-spherical-tank-api";
...
const handleDownloadTemplate = () => {
  SeSphericalTankAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await SeSphericalTankAPI.import(importFormData.files[0].raw as File);
