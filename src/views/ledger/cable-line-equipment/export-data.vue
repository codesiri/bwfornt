...
import CableLineEquipmentAPI from "@/api/ledger/cable-line-equipment-api";
...
const handleDownloadTemplate = () => {
  CableLineEquipmentAPI.downloadtemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await CableLineEquipmentAPI.importFile(importFormData.files[0].raw as File);
