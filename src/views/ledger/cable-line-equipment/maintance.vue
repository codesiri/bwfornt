    ...
    <template #default>
      ...
      >
        <el-form-item label="电缆编号" prop="cleCableCode">
          <el-input v-model="formData.cleCableCode" :disabled="true" placeholder="电缆编号" />
        </el-form-item>
...
import { CableLineEquipmentMaintenanceForm } from "@/views/ledger/cable-line-equipment";

const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<CableLineEquipmentMaintenanceForm>("formdata", { required: true });
