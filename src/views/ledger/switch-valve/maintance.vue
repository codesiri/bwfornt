    ...
    <template #default>
      ...
      >
        <el-form-item label="位号" prop="switchValveTag">
          <el-input v-model="formData.switchValveTag" :disabled="true" placeholder="位号" />
        </el-form-item>
...
import { SwitchValveMaintenanceForm } from "@/views/ledger/switch-valve";
const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<SwitchValveMaintenanceForm>("formdata", { required: true });
