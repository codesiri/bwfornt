...
import SwitchValveAPI from "@/api/ledger/switch-valve-api";
...
const handleDownloadTemplate = () => {
  SwitchValveAPI.downloadtemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await SwitchValveAPI.import(importFormData.files[0].raw as File);
