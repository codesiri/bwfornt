...
import UnitSpecialInstrumentsAPI from "@/api/ledger/unit-special-instruments-api";
import LevelGaugeAPI from "@/api/ledger/level-gauge-api";
...
const handleDownloadTemplate = () => {
  UnitSpecialInstrumentsAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await LevelGaugeAPI.import(importFormData.files[0].raw as File);
