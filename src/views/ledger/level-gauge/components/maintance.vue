    ...
    <template #default>
      ...
      >
        <el-form-item label="位号" prop="levelTag">
          <el-input v-model="formData.levelTag" :disabled="true" placeholder="位号" />
        </el-form-item>
...
import { LevelGaugeMaintenanceForm } from "@/views/ledger/level-gauge";
const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<LevelGaugeMaintenanceForm>("formdata", { required: true });
