    ...
    <template #default>
      ...
      >
        <el-form-item label="设备位号" prop="analyInstrumentCode">
          <el-input v-model="formData.analyInstrumentCode" :disabled="true" placeholder="设备位号" />
        </el-form-item>
...
import { AnalyInstrumentMaintenanceForm } from "@/views/ledger/analy-instrument";
const visable = defineModel<boolean>("visable", { required: true });
const direction = ref<DrawerProps["direction"]>("rtl");
const formData = defineModel<AnalyInstrumentMaintenanceForm>("formdata", { required: true });
