...
import AnalyInstrumentAPI from "@/api/ledger/analy-instrument-api";
...
const handleDownloadTemplate = () => {
  AnalyInstrumentAPI.downloadTemplate().then((response: any) => {
...
const handleUpload = async () => {
  ...
  try {
    const result = await AnalyInstrumentAPI.importFile(importFormData.files[0].raw as File);
